...
const Profile = (props) => {
  ...
  return (
    <div className="profile">
      <header>
        <div className="icons">
          <a className="icon" target="_blank" rel="noreferrer" href={props.github}>
          ...
          <a className="icon" target="_blank" rel="noreferrer" href={props.linkedin}>
            <svg viewBox="0 0 25 25">
          ...
          <a className="icon" target="_blank" rel="noreferrer" href={`mailto:${props.email}`}>
            <svg viewBox="0 0 25 25">
